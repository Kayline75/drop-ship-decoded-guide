      ...
      <div id="parties" className="bg-brand-gray/10 py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <PartCard number={1} title="Comprendre le modèle" description="Les bases du dropshipping, la chaine logistique et le choix des fournisseurs." color="custom1" />
            <PartCard number={2} title="Trouver sa niche" description="Comment identifier une niche rentable et analyser la concurrence." color="custom2" />
            <PartCard number={3} title="Construire sa boutique" description="Choisir sa plateforme e-commerce et structurer son site pour convertir." color="custom3" />
            <PartCard number={4} title="Travailler avec des fournisseurs" description="Trouver des fournisseurs fiables et communiquer efficacement avec eux." color="custom1" />
            <PartCard number={5} title="Créer des offres irrésistibles" description="Rédiger des fiches produit qui convertissent et définir une stratégie de prix." color="custom2" />
            <PartCard number={6} title="Marketing et acquisition" description="Lancer des publicités efficaces, utiliser l'IA et le marketing d'influence." color="custom3" />
            <PartCard number={7} title="Gestion et suivi" description="Automatiser les commandes et gérer efficacement le suivi des livraisons." color="custom1" />
            <PartCard number={8} title="Optimiser et faire grandir" description="Améliorer le taux de conversion et augmenter le panier moyen avec des upsells." color="custom2" />
            <PartCard number={9} title="Légal et sécurité" description="Comprendre vos obligations légales et choisir où ouvrir votre société." color="custom3" />
            <PartCard number={10} title="Aller plus loin" description="Lancer une seconde boutique et externaliser certaines missions pour scaler." color="custom1" className="md:col-span-2 lg:col-span-1" />
          </div>
