...
const Benefits = () => {
  ...
  return <div id="benefices" className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 bg-slate-950">
          {benefits.map((benefit, index) => <div key={index} className={`p-6 rounded-lg border border-brand-${benefit.color}/20 hover:border-brand-${benefit.color}/50 transition-all duration-300 bg-white hover:shadow-xl`}>
