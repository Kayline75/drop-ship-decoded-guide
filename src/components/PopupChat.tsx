...
const PopupChat = () => {
  ...
  return <>
      ...
      <div className={`fixed bottom-6 right-6 z-50 transition-all duration-300 transform ${showPopup ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
        ...
        <DialogContent className="sm:max-w-[600px] h-[80vh] max-h-[600px] p-0 border border-[#FF7E33]/20 bg-black/90 backdrop-blur-lg text-white">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-hidden">
              <iframe src="https://chatgpt.com/g/g-682cfd7935e481919c1d406c4b5b2d80-coach-dropshipping-expert-francais" className="w-full h-full border-none" title="Coach Dropshipping" allow="microphone; camera; display-capture" />
            </div>
          </div>
        </DialogContent>
      </Dialog>
