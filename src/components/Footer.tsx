        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#cours" className="text-white hover:text-[#33C3F0] transition-colors block">Le cours</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-white">+33 1 23 45 67 89</li>
              <li className="text-white">Paris, France</li>
            </ul>
          </div>
        </div>
