      ...
      <div className="container-uniform py-0">
        ...
        <div className="mb-12 relative">
          ...
          loop: true
            ...
            <CarouselContent>
              {tabsData.map((tab, index) => <CarouselItem key={tab.id} id={`slide-${index}`} className="pt-0">
                  <motion.div initial={{
                opacity: 0,
                y: 20
              }} animate={{
                      ...
                      <CardContent className="p-0">
                        <div className="p-6 bg-[#22110A] rounded-lg shadow-md">
                          ...
                          <div className="space-y-6">
                            {tab.content.map((item, i) => <div key={i} className="flex flex-col md:flex-row items-start md:items-center gap-3">
                          ...
                          {/* Call to action */}
                          {index === 3 && <div className="mt-8 flex justify-center">
                              <a href="https://www.skool.com/klicksell-academie-5416/about?ref=78558161b3d140c79291ccbc46e5275c" className="inline-flex items-center justify-center gap-2 rounded-md text-lg font-bold bg-gradient-to-r from-[#FF7E33] to-[#FF5733] text-white px-6 py-4 hover:opacity-90 transition-all shadow-[0_0_20px_rgba(255,87,51,0.4)]">
            ...
            <div className="flex justify-center gap-2 mt-6">
              ...
              <div className="flex items-center gap-1 px-2">
                {tabsData.map((_, index) => <button key={index} onClick={() => document.getElementById(`slide-${index}`)?.scrollIntoView({
                behavior: 'smooth',
                inline: 'center'
              })} className={`w-3 h-3 rounded-full transition-all ${activeTab === index ? "bg-[#FF7E33]" : "bg-[#FF9F3F]/30"}`} aria-label={`Go to slide ${index + 1}`} />)}
              </div>
