...
const ServiceToolsSection = () => {
  ...
  return (
    <div id="outils" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center">
          <p className="text-xl font-medium mb-6 text-brand-dark">Et de nombreux autres outils et ressources inclus!</p>
        </div>
      </div>
    </div>
  );
