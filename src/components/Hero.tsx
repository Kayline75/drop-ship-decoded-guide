...
const Hero = () => {
  ...
  const packageIcons = [
    { x: "10%", y: "30%", delay: "1.5s", size: 18, rotation: "5deg", duration: "6s" },
    { x: "85%", y: "25%", delay: "2s", size: 22, rotation: "-8deg", duration: "7s" },
    { x: "30%", y: "85%", delay: "2.5s", size: 16, rotation: "12deg", duration: "8s" },
    { x: "70%", y: "70%", delay: "3s", size: 20, rotation: "-15deg", duration: "5s" },
    { x: "45%", y: "15%", delay: "3.5s", size: 24, rotation: "0deg", duration: "9s" },
    { x: "15%", y: "50%", delay: "2.8s", size: 19, rotation: "20deg", duration: "6.5s" },
    { x: "55%", y: "65%", delay: "1.8s", size: 17, rotation: "-10deg", duration: "7.5s" },
    { x: "78%", y: "42%", delay: "3.2s", size: 21, rotation: "8deg", duration: "8.5s" },
    { x: "25%", y: "10%", delay: "2.2s", size: 23, rotation: "-3deg", duration: "7.2s" },
    { x: "60%", y: "30%", delay: "1.2s", size: 18, rotation: "15deg", duration: "5.8s" },
    { x: "90%", y: "60%", delay: "2.7s", size: 16, rotation: "-18deg", duration: "6.3s" },
    { x: "5%", y: "75%", delay: "3.7s", size: 20, rotation: "7deg", duration: "8.2s" }
  ];

  // Generate airplane icons with custom animations
  const airplaneIcons = [
    { x: "20%", y: "40%", delay: "1s", size: 28, rotation: "25deg", duration: "12s", direction: "right" },
    { x: "75%", y: "20%", delay: "5s", size: 24, rotation: "-15deg", duration: "15s", direction: "left" }
  ];
    ...
    >
      ...
      {airplaneIcons.map((item, i) => (
        ...
        >
          <Plane 
            size={item.size} 
            className={`text-white hover:text-[#F97316] transition-colors ${item.direction === 'left' ? 'flip-horizontal' : ''}`}
          />
        </div>
      ))}
